      ...
      <div class="card-body table-responsivep-0">
       <table class="table table-hover box-body text-wrap table-bordered">
         <tbody>
          <tr>
            <td colspan="3">
              <button type="button" data-loading-text="<i class='fa fa-spinner fa-spin'></i> {{ vncore_language_render('admin.cache.cache_clear_processing')}}" class="btn btn-sm btn-flat btn-success clear-cache" data-clear="cache_all">
          ...
          <tr>
            ...
            <td>
              <a href="#" class="cache-time data-cache_time"  data-name="cache_time" data-type="text" data-pk="" data-url="{{ vncore_route_admin('admin_config_global.update') }}" data-title="{{ vncore_language_render('admin.cache.cache_time') }}">{{ vncore_config_admin('cache_time') }}</a>
            </td>
            <td></td>
          </tr>
           ...
           <tr>
            ...
            <td>
              <button type="button" data-loading-text="<i class='fa fa-spinner fa-spin'></i> {{ vncore_language_render('admin.cache.cache_clear')}}" class="btn btn-sm btn-flat btn-warning clear-cache" data-clear="{{ $config->key }}">
