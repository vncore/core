...
<div class="card-body p-0">
  ...
  <div class="dd" id="menu-sort">
      <ol class="dd-list">
@php
  $menus = \Vncore\Core\Admin\Models\AdminMenu::getMenuGroupByParentId();
@endphp
{{-- Level 0 --}}
              ...
              <div class="card-header with-border">
                ...
                <div class="card-tools">
                    <div class="btn-group float-right" style="margin-right: 5px">
                        <a href="{{ vncore_route_admin('admin_menu.index') }}" class="btn btn-sm  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ vncore_language_render('admin.back_list') }}</span></a>
                    </div>
                </div>
                @endif
              </div>
