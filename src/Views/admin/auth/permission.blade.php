         ...
         <div class="card">
                            ...
                            <div class="form-group row  {{ $errors->has('name') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text"   id="name" name="name" value="{{ old('name',$permission['name']??'')}}" class="form-control form-control-sm name" placeholder="" />
                                    </div>
                                        @if ($errors->has('name'))
                            ...
                            <div class="form-group row  {{ $errors->has('slug') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text"   id="slug" name="slug" value="{{ old('slug',$permission['slug']??'') }}" class="form-control form-control-sm slug" placeholder="" />
                                    </div>
                                        @if ($errors->has('slug'))
                                            <span class="form-text">
                ...
                {{-- select http_method --}}
                        <div class="form-group row {{ $errors->has('http_uri') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control form-control-sm input-sm http_uri select2"  multiple="multiple" data-placeholder="{{ vncore_language_render('admin.permission.method_placeholder') }}" style="width: 100%;" name="http_uri[]" >
                                    <option value=""></option>
