                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                       ...
                                       <span class="input-group-btn">
                                        ...
                                        @endif
                                    <div id="preview_avatar" class="img_holder"><img src="{{ vncore_file(old('avatar',$user['avatar']??'')) }}"></div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        @else
                                            @if ($user)
                                                <span class="form-text">
                                                    <i class="fa fa-info-circle"></i> {{ vncore_language_render('admin.user.keep_password') }}
                                                 </span>
                                            @endif
                                        @endif
                                </div>
...
{{-- select permission --}}
        ...
        @endphp
                                <label for="permission" class="col-sm-2  control-label">{{ vncore_language_render('admin.user.select_permission') }}</label>
                                <div class="col-sm-8">
