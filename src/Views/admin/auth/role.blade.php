                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ vncore_route_admin('admin_role.index') }}" class="btn btn-sm  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ vncore_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                            ...
                            <div class="form-group  row {{ $errors->has('name') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text"   id="name" name="name" value="{{ old('name',$role['name']??'')}}" class="form-control form-control-sm name" placeholder="" />
                                    </div>
                                        @if ($errors->has('name'))
                            ...
                            <div class="form-group  row {{ $errors->has('slug') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text"   id="slug" name="slug" value="{{ old('slug',$role['slug']??'') }}" class="form-control form-control-sm slug" placeholder="" />
                                    </div>
                                        @if ($errors->has('slug'))
                                            <span class="form-text">
...
{{-- select permission --}}
                            ...
                            <div class="form-group row {{ $errors->has('permission') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control form-control-sm input-sm permission select2"  multiple="multiple" data-placeholder="{{ vncore_language_render('admin.role.select_permission') }}" style="width: 100%;" name="permission[]" >
                                        <option value=""></option>
...
{{-- select administrators --}}
                        ...
                        <div class="form-group row {{ $errors->has('administrators') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control form-control-sm input-sm administrators select2"  multiple="multiple" data-placeholder="{{ vncore_language_render('admin.role.select_user') }}" style="width: 100%;" name="administrators[]" >
                                    <option value=""></option>
