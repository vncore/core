          ...
          <tbody>
            ...
            <tr>
              <td class="header" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:25px 0;text-align:center">
                <a href="{{ vncore_route_admin('home') }}" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#bbbfc3;font-size:19px;font-weight:bold;text-decoration:none" target="_blank">
                  {{ config('app.name') }}
                </a>
              </td>
            </tr>
                  ...
                  <tr>
                      <td class="content-cell" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px">
                        ...
                        <p style="box-sizing:border-box;font-family:Avenir,Helvetica,sans-serif;font-size:14px;line-height:1.5em;margin-top:0;text-align:left">
                          {{ vncore_language_render('email.msg_goodbye') }}<br>
                          {{ config('app.name') }}
                        </p>
                      </td>
                    </tr>
