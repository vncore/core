      ...
      <img src="{{ vncore_file(vncore_store('logo')) }}" style="max-height:60px;">
        <div class="page-tools">
            <div class="action-buttons">
                ...
                {{-- <a class="btn btn-sm bg-white btn-light mx-1px text-95 dont-print" href="#" data-title="PDF">
                ...
                <div class="row">
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-1"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-90">{{ vncore_language_render('order.date') }}:</span> {{ vncore_datetime_to_date($created_at, 'Y-m-d') }}</div>
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            <div class="row my-2">
                                ...
                                <div class="col-5 text-right">
                                    <span class="text-120 text-secondary-d1">{{ vncore_currency_render_symbol($subtotal, $currency) }}</span>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-7 text-right">
                                ...
                                <div class="col-5 text-right">
                                    <span class="text-120 text-secondary-d1">{{ vncore_currency_render_symbol($tax, $currency) }}</span>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-7 text-right">
                                ...
                                <div class="col-5 text-right">
                                    <span class="text-120 text-secondary-d1">{{ vncore_currency_render_symbol($shipping, $currency) }}</span>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-7 text-right">
                                ...
                                <div class="col-5 text-right">
                                    <span class="text-120 text-secondary-d1">{{ vncore_currency_render_symbol($discount, $currency) }}</span>
                                </div>
                            </div>
                            <div class="row my-2 high-light">
                                ...
                                <div class="col-5 text-right">
                                    <span class="text-120 text-secondary-d1">{{ vncore_currency_render_symbol($total, $currency) }}</span>
                                </div>
                            </div>
                            <hr>
                            <div class="row my-2">
                                ...
                                <div class="col-5 text-right">
                                    <span class="text-120 text-secondary-d1">{{ vncore_currency_render_symbol($other_fee, $currency) }}</span>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-7 text-right">
                                ...
                                <div class="col-5 text-right">
                                    <span class="text-120 text-secondary-d1">{{ vncore_currency_render_symbol($received, $currency) }}</span>
                                </div>
                            </div>
                            <div class="row my-2 align-items-center bgc-primary-l3 p-2 high-light">
                                ...
                                <div class="col-5 text-right">
                                  <span class="text-150 text-success-d3 opacity-2">{{ vncore_currency_render_symbol($balance, $currency) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
